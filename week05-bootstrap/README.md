...
Bootstrap's responsive grid made the layout a lot easier to put together. I was able to use containers, rows, and columns to make the sections responsive without having to create all of the layout and breakpoints myself.
...
I changed some of Bootstrap's default colors to match the Cedar & Stone design. I used the deep green, cedar, cream, and soft green colors from the client direction so the page felt more like the company instead of just looking like a basic Bootstrap page.
...
## Live Site
https://github.com/jenieciajae/webworks-studio/tree/main/week05-bootstrap
